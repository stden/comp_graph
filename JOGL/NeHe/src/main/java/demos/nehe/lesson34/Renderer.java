...
class Renderer implements GLEventListener {
    ...
    private void renderHeightMap(GL2 gl, byte[] pHeightMap) {              // This Renders The Height Map As Quads
    ...
    private void setVertexColor(GL2 gl, byte[] pHeightMap, int x, int y) {                 // Sets The Color Value For A Particular Index, Depending On The Height Index
