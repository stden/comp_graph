...
class Renderer implements GLEventListener {
    ...
    private void loadGLTextures(GL2 gl, GLU glu) {                            // Load image And Convert To Textures
        ...
        glu.gluBuild2DMipmaps(GL_TEXTURE_2D, 3, texture.getWidth(), texture.getHeight(), GL_RGB, GL_UNSIGNED_BYTE, texture.getPixels());
    }
