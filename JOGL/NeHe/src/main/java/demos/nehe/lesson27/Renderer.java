...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glLightfv(GL_LIGHT1, GL_POSITION, LightPos, 0);        // Set Light1 Position
        gl.glLightfv(GL_LIGHT1, GL_AMBIENT, LightAmb, 0);        // Set Light1 Ambience
        gl.glLightfv(GL_LIGHT1, GL_DIFFUSE, LightDif, 0);        // Set Light1 Diffuse
        gl.glLightfv(GL_LIGHT1, GL_SPECULAR, LightSpc, 0);        // Set Light1 Specular
        gl.glEnable(GL_LIGHT1);                                  // Enable Light1
        gl.glEnable(GL_LIGHTING);                                // Enable Lighting

        gl.glMaterialfv(GL_FRONT, GL_AMBIENT, MatAmb, 0);         // Set Material Ambience
        gl.glMaterialfv(GL_FRONT, GL_DIFFUSE, MatDif, 0);         // Set Material Diffuse
        gl.glMaterialfv(GL_FRONT, GL_SPECULAR, MatSpc, 0);        // Set Material Specular
        gl.glMaterialfv(GL_FRONT, GL_SHININESS, MatShn, 0);       // Set Material Shininess

        gl.glCullFace(GL_BACK);                                  // Set Culling Face To Back Face
        gl.glEnable(GL_CULL_FACE);                               // Enable Culling
        gl.glClearColor(0.1f, 1.0f, 0.5f, 1.0f);                    // Set Clear Color (Greenish Color)

        quadric = glu.gluNewQuadric();                              // Initialize Quadratic
        glu.gluQuadricNormals(quadric, GL_SMOOTH);                      // Enable Smooth Normal Generation
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glLightfv(GL_LIGHT1, GL_POSITION, LightPos, 0);        // Position Light1
        ...
        gl.glGetFloatv(GL_MODELVIEW_MATRIX, Minv.e, 0);      // Retrieve ModelView Matrix (Stores In Minv)
        ...
        gl.glGetFloatv(GL_MODELVIEW_MATRIX, Minv.e, 0);      // Retrieve ModelView Matrix From Minv
