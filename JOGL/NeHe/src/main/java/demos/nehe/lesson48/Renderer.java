...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glShadeModel(GL_FLAT);                                            // Select Flat Shading (Nice Definition Of Objects)
        ...
        gl.glEnable(GL_LIGHT0);                                            // Enable Default Light
        gl.glEnable(GL_LIGHTING);                                            // Enable Lighting

        gl.glEnable(GL_COLOR_MATERIAL);                                    // Enable Color Material
    }
