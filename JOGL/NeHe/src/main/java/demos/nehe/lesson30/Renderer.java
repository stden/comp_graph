...
class Renderer implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glMaterialfv(GL_FRONT, GL_SPECULAR, spec, 0);
        gl.glMaterialfv(GL_FRONT, GL_SHININESS, df, 0);

        gl.glEnable(GL_LIGHTING);
        gl.glLightfv(GL_LIGHT0, GL_POSITION, posl, 0);
        gl.glLightfv(GL_LIGHT0, GL_AMBIENT, amb2, 0);
        gl.glEnable(GL_LIGHT0);

        gl.glLightModelfv(GL_LIGHT_MODEL_AMBIENT, amb, 0);
        ...
        gl.glNewList(dlist = gl.glGenLists(1), GL_COMPILE);
        gl.glBegin(GL_QUADS);
    ...
    private void loadGLTextures(GL2 gl) {
        ...
        gl.glBindTexture(GL_TEXTURE_2D, texture[0][0]);   /* 2d texture (x and y size)*/

        gl.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR); /* scale linearly when image bigger than texture*/
        gl.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR); /* scale linearly when image smalled than texture*/
        gl.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
        gl.glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);

        /* 2d texture, level of detail 0 (normal), 3 components (red, green, blue), x size from image, y size from image, */
        /* border 0 (normal), rgb color data, unsigned byte data, and finally the data itself.*/
        gl.glTexImage2D(GL_TEXTURE_2D, 0, 3, image1.getWidth(), image1.getHeight(), 0, GL_RGB, GL_UNSIGNED_BYTE, image1.getPixels());

        /* Create Texture	******************************************/
        gl.glBindTexture(GL_TEXTURE_2D, texture[0][1]);   /* 2d texture (x and y size)*/
        ...
        /* 2d texture, level of detail 0 (normal), 3 components (red, green, blue), x size from image, y size from image, */
        /* border 0 (normal), rgb color data, unsigned byte data, and finally the data itself.*/
        gl.glTexImage2D(GL_TEXTURE_2D, 0, 3, image2.getWidth(), image2.getHeight(), 0, GL_RGB, GL_UNSIGNED_BYTE, image2.getPixels());


        /* Create Texture	********************************************/
        gl.glGenTextures(2, texture[1], 0);
        gl.glBindTexture(GL_TEXTURE_2D, texture[1][0]);   /* 2d texture (x and y size)*/
        ...
        /* 2d texture, level of detail 0 (normal), 3 components (red, green, blue), x size from image, y size from image, */
        /* border 0 (normal), rgb color data, unsigned byte data, and finally the data itself.*/
        gl.glTexImage2D(GL_TEXTURE_2D, 0, 3, image3.getWidth(), image3.getHeight(), 0, GL_RGB, GL_UNSIGNED_BYTE, image3.getPixels());

        /* Create Texture	*********************************************/
        gl.glBindTexture(GL_TEXTURE_2D, texture[1][1]);   /* 2d texture (x and y size)*/
        ...
        /* 2d texture, level of detail 0 (normal), 3 components (red, green, blue), x size from image, y size from image, */
        /* border 0 (normal), rgb color data, unsigned byte data, and finally the data itself.*/
        gl.glTexImage2D(GL_TEXTURE_2D, 0, 3, image4.getWidth(), image4.getHeight(), 0, GL_RGB, GL_UNSIGNED_BYTE, image4.getPixels());
    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glBindTexture(GL_TEXTURE_2D, texture[1][1]);
        gl.glColor3f(1, 1, 1);
        gl.glBegin(GL_QUADS);
        gl.glTexCoord2f(1.0f, 0.0f);
        ...
        gl.glBindTexture(GL_TEXTURE_2D, texture[1][0]);
        gl.glBegin(GL_QUADS);
        gl.glTexCoord2f(1.0f, 0.0f);
        gl.glVertex3f(-320, -320, 320);
        gl.glTexCoord2f(1.0f, 1.0f);
        ...
        gl.glBindTexture(GL_TEXTURE_2D, texture[0][0]);   /* choose the texture to use.*/
        ...
        gl.glBindTexture(GL_TEXTURE_2D, texture[0][1]);
