...
class Camera {
    ...
    public void setPrespective(GL2 gl) {
        ...
        gl.glGetFloatv(GL_MODELVIEW_MATRIX, Matrix, 0);
    ...
    private void updateFrustum(GL2 gl) {
        ...
        gl.glGetFloatv(GL_MODELVIEW_MATRIX, modl, 0);
    ...
    public void updateFrustumFaster(GL2 gl) {
    ...
    public void renderLensFlare(GL2 gl) {
        ...
        if (sphereInFrustum(m_LightSourcePos, 1.0f)) {
            ...
            gl.glEnable(GL_BLEND);                                   // You should already know what this does
            gl.glBlendFunc(GL_SRC_ALPHA, GL_ONE);                  // You should already know what this does
            gl.glDisable(GL_DEPTH_TEST);                             // You should already know what this does
            gl.glEnable(GL_TEXTURE_2D);                              // You should already know what this does
            ...
            gl.glDisable(GL_BLEND);                                           // You should already know what this does
            gl.glEnable(GL_DEPTH_TEST);                                        // You should already know what this does
            gl.glDisable(GL_TEXTURE_2D);                                       // You should already know what this does
        }
    }
    ...
    private void renderHalo(GL2 gl, float r, float g, float b, float a, Tuple3f p, float scale) {
        ...
        gl.glRotatef(-m_HeadingDegrees, 0.0f, 1.0f, 0.0f);
        gl.glRotatef(-m_PitchDegrees, 1.0f, 0.0f, 0.0f);
        gl.glBindTexture(GL_TEXTURE_2D, m_HaloTexture[0]); // Bind to the Big Glow texture
        gl.glColor4f(r, g, b, a);                             // Set the color since the texture is a gray scale

        gl.glBegin(GL_TRIANGLE_STRIP);                     // Draw the Big Glow on a Triangle Strip
    ...
    private void renderGlow(GL2 gl, float r, float g, float b, float a, Tuple3f p, float scale) {
        ...
        gl.glRotatef(-m_HeadingDegrees, 0.0f, 1.0f, 0.0f);
        gl.glRotatef(-m_PitchDegrees, 1.0f, 0.0f, 0.0f);
        gl.glBindTexture(GL_TEXTURE_2D, m_GlowTexture[0]); // Bind to the Big Glow texture
        gl.glColor4f(r, g, b, a);                             // Set the color since the texture is a gray scale
    ...
    private void renderBigGlow(GL2 gl, float r, float g, float b, float a, Tuple3f p, float scale) {
        ...
        gl.glRotatef(-m_HeadingDegrees, 0.0f, 1.0f, 0.0f);
        gl.glRotatef(-m_PitchDegrees, 1.0f, 0.0f, 0.0f);
        gl.glBindTexture(GL_TEXTURE_2D, m_BigGlowTexture[0]); // Bind to the Big Glow texture
        gl.glColor4f(r, g, b, a);                                // Set the color since the texture is a gray scale
    ...
    private void renderStreaks(GL2 gl, float r, float g, float b, float a, Tuple3f p, float scale) {
        ...
        gl.glRotatef(-m_HeadingDegrees, 0.0f, 1.0f, 0.0f);
        gl.glRotatef(-m_PitchDegrees, 1.0f, 0.0f, 0.0f);
        gl.glBindTexture(GL_TEXTURE_2D, m_StreakTexture[0]); // Bind to the Big Glow texture
        gl.glColor4f(r, g, b, a);                               // Set the color since the texture is a gray scale
