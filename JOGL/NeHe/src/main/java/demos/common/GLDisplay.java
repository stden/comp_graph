...
public class GLDisplay {
    ...
    private GLDisplay(String title, int width, int height, boolean fullscreen) {
        glCanvas = new GLCanvas(new GLCapabilities(GLProfile.getMaxFixedFunc(true)));
    ...
    public static GLDisplay createGLDisplay(String title) {
        ...
        boolean fullscreen = goFullScreen(title, device);
        return new GLDisplay(title, DEFAULT_WIDTH, DEFAULT_HEIGHT, fullscreen);
    }

    private static boolean goFullScreen(String title, GraphicsDevice device) {
    ...
    private static class MyHelpOverlayGLEventListener implements GLEventListener {
        ...
        public void display(GLAutoDrawable glDrawable) {
            for (Object eventListener : eventListeners) {
                ((GLEventListener) eventListener).display(glDrawable);
            }
            if (showHelp)
        ...
        public void init(GLAutoDrawable glDrawable) {
            for (Object eventListener : eventListeners) {
                ((GLEventListener) eventListener).init(glDrawable);
            }
        }
        ...
        public void reshape(GLAutoDrawable glDrawable, int i0, int i1, int i2, int i3) {
            for (Object eventListener : eventListeners) {
                ((GLEventListener) eventListener).reshape(glDrawable, i0, i1, i2, i3);
            }
        }
    }
