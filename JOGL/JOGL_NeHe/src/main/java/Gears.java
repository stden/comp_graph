...
public class Gears implements GLEventListener {
    ...
    /* draw front face */
        ...
        for (i = 0; i <= teeth; i++) {
            ...
            if (i < teeth) {
                gl.glVertex3f(r0 * (float) cos(angle), r0 * (float) sin(angle), width * 0.5f);
                gl.glVertex3f(r1 * (float) cos(angle + 3.0f * da), r1 * (float) sin(angle + 3.0f * da), width * 0.5f);
            }
        }
        gl.glEnd();
    ...
    /* draw front sides of teeth */
        ...
        for (i = 0; i < teeth; i++) {
            ...
            gl.glVertex3f(r2 * (float) cos(angle + 2.0f * da), r2 * (float) sin(angle + 2.0f * da), width * 0.5f);
            gl.glVertex3f(r1 * (float) cos(angle + 3.0f * da), r1 * (float) sin(angle + 3.0f * da), width * 0.5f);
        }
        gl.glEnd();
    ...
    /* draw outward faces of teeth */
        ...
        for (i = 0; i < teeth; i++) {
            ...
            gl.glVertex3f(r2 * (float) cos(angle + da), r2 * (float) sin(angle + da), width * 0.5f);
            gl.glVertex3f(r2 * (float) cos(angle + da), r2 * (float) sin(angle + da), -width * 0.5f);
            gl.glNormal3f((float) cos(angle), (float) sin(angle), 0.0f);
            gl.glVertex3f(r2 * (float) cos(angle + 2 * da), r2 * (float) sin(angle + 2 * da), width * 0.5f);
            gl.glVertex3f(r2 * (float) cos(angle + 2 * da), r2 * (float) sin(angle + 2 * da), -width * 0.5f);
