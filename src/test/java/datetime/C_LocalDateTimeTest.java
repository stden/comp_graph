...
public class C_LocalDateTimeTest extends Assert {
    ...
    public void testParseDate() {
        ...
        // Разные версии JDK возвращают разные строки для русской локали
        String russianEra = era.getDisplayName(TextStyle.FULL, Locale.forLanguageTag("RU"));
        assertTrue("Должно быть одно из: 'н.э.' или 'от Рождества Христова'",
                russianEra.equals("н.э.") || russianEra.equals("от Рождества Христова"));
        ...
        // Разные версии JDK возвращают разные строки для русской локали
        String russianBCEra = e.getDisplayName(TextStyle.FULL, Locale.forLanguageTag("RU"));
        assertTrue("Должно быть одно из: 'до н.э.' или 'до Рождества Христова'",
                russianBCEra.equals("до н.э.") || russianBCEra.equals("до Рождества Христова"));
