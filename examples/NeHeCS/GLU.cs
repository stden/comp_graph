...
namespace OpenGL
{
    ...
    public class GLU
    {
        ...
        public static extern int gluProject(double objx, double objy, double objz, double modelMatrix, double projMatrix,
            int viewport, ref double winx, ref double winy, ref double winz);

        [DllImport(GLU_DLL, EntryPoint = "gluUnProject")]
        public static extern int gluUnProject(double winx, double winy, double winz, double modelMatrix,
            double projMatrix, int viewport, ref double objx, ref double objy, ref double objz);

        [DllImport(GLU_DLL, EntryPoint = "gluScaleImage")]
        public static extern int gluScaleImage(uint format, int widthin, int heightin, uint typein, object[] datain,
            int widthout, int heightout, uint typeout, object[] dataout);

        [DllImport(GLU_DLL, EntryPoint = "gluBuild1DMipmaps")]
        public static extern int gluBuild1DMipmaps(uint target, int components, int width, uint format, uint type,
            object[] data);

        [DllImport(GLU_DLL, EntryPoint = "gluBuild2DMipmaps")]
        public static extern int gluBuild2DMipmaps(uint target, int components, int width, int height, uint format,
            uint type, object[] data);
        ...
        public static extern void gluCylinder(ref object qobj, double baseRadius, double topRadius, double height,
        ...
        public static extern void gluPartialDisk(ref object qobj, double innerRadius, double outerRadius, int slices,
        ...
        public static extern void gluNurbsCurve(IntPtr nobj, int nknots, float[] knot, int stride, float[] ctlarray,
            int order, uint type);

        [DllImport(GLU_DLL, EntryPoint = "gluNurbsSurface")]
        public static extern void gluNurbsSurface(IntPtr nobj, int sknot_count, float[] sknot, int tknot_count,
